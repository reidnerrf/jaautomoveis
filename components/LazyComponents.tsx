...
export const LazyGoogleReviewsCarousel = lazy(
  () => import("./GoogleReviewsCarousel"),
);
export const LazyGoogleReviewSummary = lazy(
  () => import("./GoogleReviewSummary"),
);
...
export const LazyAdminVehicleList = lazy(
  () => import("../pages/AdminVehicleListPage"),
);
export const LazyAdminVehicleForm = lazy(
...
const VehicleCarouselSkeleton = () => (
  <div className="animate-pulse">
    ...
    <div className="flex space-x-2">
      {[...Array(4)].map((_, i) => (
        <div
          key={`carousel-skeleton-${i + 1}`}
          className="w-24 h-16 bg-gray-200 rounded"
        ></div>
      ))}
    </div>
  </div>
    ...
    <div className="flex space-x-4">
      {[...Array(3)].map((_, i) => (
        <div
          ...
          className="flex-1 bg-gray-50 p-4 rounded"
        >
...
export const LazyVehicleCarouselWithLoading = withLazyLoading(
  LazyVehicleCarousel,
  VehicleCarouselSkeleton,
);
export const LazyPriceComparisonWithLoading = withLazyLoading(
  LazyPriceComparison,
  PriceComparisonSkeleton,
);
export const LazyGoogleReviewsWithLoading = withLazyLoading(
  LazyGoogleReviewsCarousel,
  ReviewsSkeleton,
);
export const LazyInventoryPageWithLoading = withLazyLoading(
  LazyInventoryPage,
  PageSkeleton,
);
export const LazyVehicleDetailPageWithLoading = withLazyLoading(
