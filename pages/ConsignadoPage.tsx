          ...
          {JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Consignado",
                item: typeof window !== "undefined" ? `${window.location.origin}/consignado` : "",
              },
            ],
          })}
        </script>
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "É quando o proprietário deixa o veículo na loja (consignatário) para que esta realize a venda por um valor e prazo acordados, sem transferência de propriedade para a loja.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Loja cuida da divulgação, negociação, segurança e documentação; você evita golpes, ganha visibilidade e negocia melhor, pagando uma comissão sobre a venda.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "A loja cobra uma comissão acordada sobre o valor de venda do veículo, somente quando a venda é concluída.",
                },
              },
            ],
          })}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Entregue seu veículo para nossa equipe vender em seu nome, com divulgação profissional e
            segurança. Você segue como proprietário até a venda e recebe à vista.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              Um carro consignado é um veículo entregue à loja para que ela faça toda a divulgação,
              negociação e venda em nome do proprietário. O dono continua sendo o proprietário legal
              até a conclusão da venda e a transferência ao comprador.
            </p>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-3 text-gray-600 dark:text-gray-300">
              <li className="flex items-start gap-3">
                <FaCheckCircle className="text-red-500 mt-1" /> Divulgação profissional do veículo
                nos principais canais.
              </li>
              <li className="flex items-start gap-3">
                <FaUserShield className="text-red-500 mt-1" /> Negociação e segurança jurídica
                conduzidas pela loja.
              </li>
              <li className="flex items-start gap-3">
                <FaRegClock className="text-red-500 mt-1" /> Você não precisa parar sua rotina:
                cuidamos de todo o processo.
              </li>
              <li className="flex items-start gap-3">
                <FaPercentage className="text-red-500 mt-1" /> Pagamento ao proprietário à vista
                após a venda, com comissão transparente.
              </li>
            </ul>
          </motion.div>
          ...
          >
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
              Por que consignar com a JA Automóveis?
            </h2>
            <ul className="space-y-3 text-gray-600 dark:text-gray-300">
              <li className="flex items-start gap-3">
                <FaCheckCircle className="text-red-500 mt-1" /> Equipe experiente e reputação local.
              </li>
              <li className="flex items-start gap-3">
                <FaCheckCircle className="text-red-500 mt-1" /> Fotos profissionais e anúncios em
                múltiplos portais.
              </li>
              <li className="flex items-start gap-3">
                <FaCheckCircle className="text-red-500 mt-1" /> Processo transparente, contrato
                claro e segurança na transação.
              </li>
            </ul>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Trabalhamos com termo de consignação definindo prazos e condições, normalmente com
                exclusividade pelo período acordado.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Qual a comissão?</h3>
              <p className="text-gray-600 dark:text-gray-300">
                A comissão é previamente acordada e somente aplicada quando a venda for concluída.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">
                E se eu quiser retirar o carro?
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
                Você pode solicitar a retirada conforme condições do contrato; cuidamos da
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Sim. O repasse é feito à vista para o proprietário, e a transferência é realizada ao
                comprador com toda a documentação.
              </p>
            </div>
          </div>
        </section>
        ...
        >
          ...
          <span className="text-gray-500 dark:text-gray-400 text-sm">
            Tire suas dúvidas e solicite a avaliação do seu veículo.
          </span>
        </motion.div>
      </div>
    </div>
