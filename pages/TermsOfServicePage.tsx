        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className={sectionClasses}>
            ...
            <p className={textClasses}>
              Ao acessar ao site JA Automóveis, concorda em cumprir estes termos de serviço, todas
              as leis e regulamentos aplicáveis e concorda que é responsável pelo cumprimento de
          ...
          <div className={sectionClasses}>
            ...
            <p className={textClasses}>
              ...
              ou software) no site JA Automóveis...
            </p>
          ...
          <div className={sectionClasses}>
            ...
            <p className={textClasses}>
              Os materiais no site da JA Automóveis são fornecidos &ldquo;como estão&rdquo;. JA
              Automóveis não oferece garantias, expressas ou implícitas...
            </p>
          </div>
          ...
          <div className={sectionClasses}>
            ...
            <p className={textClasses}>
              Em nenhum caso o JA Automóveis ou seus fornecedores serão responsáveis por quaisquer
              danos...
            </p>
          </div>
          ...
          <div className={sectionClasses}>
            ...
            <p className={textClasses}>
              Os materiais exibidos no site podem conter erros técnicos, tipográficos ou
              fotográficos...
            </p>
          </div>
          ...
          <div className={sectionClasses}>
            ...
            <p className={textClasses}>
              O JA Automóveis pode revisar estes termos de serviço a qualquer momento, sem aviso
              prévio...
            </p>
