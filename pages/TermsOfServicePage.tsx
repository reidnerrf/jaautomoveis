...
const TermsOfServicePage: React.FC = () => {
  const sectionClasses =
    "bg-gray-50 dark:bg-gray-800 rounded-2xl shadow-sm p-6 mb-6 border border-gray-100 dark:border-gray-700";
  const headingClasses =
    "flex items-center gap-2 text-2xl font-semibold text-gray-800 dark:text-white mb-4";
        ...
        >
          ...
          <div className={sectionClasses}>
            ...
            <p className={textClasses}>
              Ao acessar ao site JA Automóveis, concorda em cumprir estes termos
              de serviço, todas as leis e regulamentos aplicáveis e concorda que
              é responsável pelo cumprimento de todas as leis locais
              aplicáveis...
            </p>
          </div>
          ...
          <div className={sectionClasses}>
            ...
            <p className={textClasses}>
              ...
              materiais (informações ou software) no site JA Automóveis...
            </p>
          ...
          <div className={sectionClasses}>
            <h2 className={headingClasses}>
              <FiShield className="text-purple-500" /> 3. Isenção de
              responsabilidade
            </h2>
            <p className={textClasses}>
              Os materiais no site da JA Automóveis são fornecidos &ldquo;como
              estão&rdquo;. JA Automóveis não oferece garantias, expressas ou
              implícitas...
            </p>
          </div>
          ...
          <div className={sectionClasses}>
            ...
            <p className={textClasses}>
              Em nenhum caso o JA Automóveis ou seus fornecedores serão
          ...
          <div className={sectionClasses}>
            ...
            <p className={textClasses}>
              Os materiais exibidos no site podem conter erros técnicos,
          ...
          <div className={sectionClasses}>
            ...
            <p className={textClasses}>
              O JA Automóveis não é responsável pelo conteúdo de sites
              vinculados...
            </p>
          </div>
          ...
          <div className={sectionClasses}>
            ...
            <p className={textClasses}>
              O JA Automóveis pode revisar estes termos de serviço a qualquer
