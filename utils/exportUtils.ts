 ...
 */
export const exportVehiclesToExcel = (vehicles: VehicleExportData[], filename: string = 'veiculos_disponiveis.xlsx') => {
  try {
 ...
 */
export const exportSellersToExcel = (sellers: SellerExportData[], filename: string = 'vendedores.xlsx') => {
  try {
